...
public:
	...
	void CopySettingsFromSoundBase(USoundBase* SoundAsset, bool bMuteSource, float& OriginalVolume);
	...
	void RestoreSoundBaseVolume(USoundBase* SoundAsset, float OriginalVolume);
